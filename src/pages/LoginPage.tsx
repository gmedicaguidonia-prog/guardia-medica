...
export function LoginPage({ user, onSignIn, isDev, onDevLogin }: Props) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="rounded-2xl shadow-2xl p-8 w-full max-w-sm text-center" style={{ background: '#faf8f3' }}>

        <div className="flex justify-center mb-6">
          <div className="rounded-full p-4" style={{ background: '#e0e8d8' }}>
            <Stethoscope size={40} style={{ color: '#476540' }} />
          </div>
        </div>

        <h1 className="text-2xl font-bold mb-1" style={{ color: '#2b3c24' }}>Guardia Medica</h1>
